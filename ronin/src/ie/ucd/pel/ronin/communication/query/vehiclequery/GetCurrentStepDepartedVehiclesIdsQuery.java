 ...
 * that are departed at the current timestep of a Ronin Simulation hosted by a
 * Ronin server.
 */
public class GetCurrentStepDepartedVehiclesIdsQuery extends Query {
     ...
     * a Ronin server. It returns a ListVehiclesIdsServerResponse to send to the
     * Client, that contains the list of ids of vehicles.
     *
